...
#define _IOKIT_PICSHARED_H 1

#if defined(APIC_DEBUG)
#define APIC_LOG(args...)  printf(args)
#else /* APIC_RELEASE */
 ...
 */
#define DATA_TO_VECTOR(data) (((UInt32 *)(data)->getBytesNoCopy())[0])
#define DATA_TO_FLAGS(data) (((UInt32 *)(data)->getBytesNoCopy())[1])
 ...
 */
#define kHandleDeepIdleFunction       "HandleDeepIdle"
